...
public class QuickUnion<D> implements UnionFind<D> {
	...
	{
		QuickUnionNode<D> tmp= new QuickUnionNode<D>(data);
	...
	{
		QuickUnionNode<D>n1=(QuickUnionNode<D>) node1;
		QuickUnionNode<D>n2=(QuickUnionNode<D>) node2;
		
		if(n1.isRepresentative() && n2.isRepresentative() && (n1!=n2))
		{
			n2.parent=n1;
		}
	}
